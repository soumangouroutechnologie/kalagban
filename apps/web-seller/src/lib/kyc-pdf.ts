...
<body>
  ...
  <div class="header">
    <div>
      <div class="logo-box">
        ...
        <span class="badge">CERTIFIÉ CONFORME 🛡️</span>
      </div>
      <div class="subtitle">Direction de la Conformité &amp; Sécurité Marchande</div>
    </div>
    <div class="header-right">
      <strong>CERTIFICAT D'ENREGISTREMENT KYC</strong>
      <div>Réf : <span style="font-family: monospace;">${(kyc.id || "KLG-CERT").slice(0, 13).toUpperCase()}</span></div>
      <div style="color: #059669; font-weight: 700;">Validé le : ${validationDate}</div>
    </div>
  </div>
  ...
  <div class="status-card">
    ...
    <div class="status-text">
      <h4>Boutique Officiellement Certifiée &amp; Conforme</h4>
      <p>Ce dossier d'identification a été audité et validé par Kalagban. Les données et pièces justificatives ci-dessous sont légalement archivées.</p>
    </div>
  </div>
  ...
  <div class="section">
    <div class="section-title">
      <span>2. Pièces Justificatives Archivées</span>
