  ...
  const steps = isHomeDelivery ? [
    {
      ...
      description: "Votre commande a été confirmée et transmise à la boutique marchande.",
      date: formattedDate,
      icon: CheckCircle2
    },
    {
    ...
    },
    {
      ...
      description: "Un livreur dédié fait route vers la boutique du vendeur pour collecter votre colis.",
    ...
    },
    {
      ...
      description: "Le livreur a récupéré votre colis chez le vendeur et fait route vers votre adresse de livraison.",
    ...
    },
    {
      ...
      description: "Le livreur est dans votre secteur / devant votre porte. Transmettez-lui votre Code OTP secret pour valider la remise.",
    ...
    },
    {
      ...
      description: "Le code OTP a été validé. Votre colis a été remis en main propre à votre domicile. Merci !",
    ...
    },
    {
      ...
      description: "Votre colis est stocké en étagère sécurisée. Présentez votre Code OTP au gérant.",
      date: currentStep >= 5 ? formattedDate : "--",
      icon: MapPin,
      showOtp: Boolean(pickupCode)
    },
