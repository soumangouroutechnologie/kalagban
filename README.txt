...
3. Détail des Applications & Packages
4. Logique Métier & Flux Clés
5. Base de Données & Sécurité Supabase (RLS)
6. Variables d'Environnement
7. Installation & Démarrage
8. Build & Déploiement (Web & Mobile APK)
9. Guide pour les Développeurs Entrants
10. Tests de Charge & Performance
11. Support & Maintenance

================================================================================
1. VUE D'ENSEMBLE DU PROJET
================================================================================
Kalagban est une infrastructure e-commerce complète reliant acheteurs, vendeurs
professionnels, agents de points relais et livreurs à domicile.

Fonctionnalités Clés :
- Marketplace Multi-Tenant : Gestion de boutiques indépendantes avec modération des produits.
...
│   ├── functions/          # Deno Edge Functions (send-otp-zavu, send-push-notification)
...
- Fonctions :
  ...
  * Réception des colis déposés par les vendeurs (Vérification statut 'shipped').
...
Package TypeScript centralisé garantissant l'exactitude des calculs de commission :
...
2. Lancement en Mode Développement :
   ...
   npm run dev --workspace=web-buyer      # Boutique Web Acheteur (Port 3000)
   npm run dev --workspace=web-seller     # Espace Vendeur Web (Port 3001)
   npm run dev --workspace=web-admin      # Super Admin Web (Port 3002)
   npm run dev --workspace=web-relay      # Portail Points Relais (Port 3003)
   npm run start --workspace=mobile-buyer # App Mobile Acheteur
   npm run start --workspace=mobile-seller# App Mobile Vendeur
...
- npm run test:load:smoke   # Test de fumée
- npm run test:load:buyer   # Parcours complet acheteur
- npm run test:load:stress  # Test de résistance
- npm run test:load:spike   # Pic de trafic (Spike sale)
- npm run test:load:kpay    # Test flux K-Pay
